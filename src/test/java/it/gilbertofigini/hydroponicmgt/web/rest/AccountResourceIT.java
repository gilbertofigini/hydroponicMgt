package it.gilbertofigini.hydroponicmgt.web.rest;

import it.gilbertofigini.hydroponicmgt.HydroponicMgtApp;
import it.gilbertofigini.hydroponicmgt.config.Constants;
import it.gilbertofigini.hydroponicmgt.domain.Authority;
import it.gilbertofigini.hydroponicmgt.domain.PersistentToken;
import it.gilbertofigini.hydroponicmgt.domain.User;
import it.gilbertofigini.hydroponicmgt.repository.AuthorityRepository;
import it.gilbertofigini.hydroponicmgt.repository.PersistentTokenRepository;
import it.gilbertofigini.hydroponicmgt.repository.UserRepository;
import it.gilbertofigini.hydroponicmgt.security.AuthoritiesConstants;
import it.gilbertofigini.hydroponicmgt.service.UserService;
import it.gilbertofigini.hydroponicmgt.service.dto.PasswordChangeDTO;
import it.gilbertofigini.hydroponicmgt.service.dto.UserDTO;
import it.gilbertofigini.hydroponicmgt.web.rest.vm.KeyAndPasswordVM;
import it.gilbertofigini.hydroponicmgt.web.rest.vm.ManagedUserVM;
...
import static it.gilbertofigini.hydroponicmgt.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = HydroponicMgtApp.class)
